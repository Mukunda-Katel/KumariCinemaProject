...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-section">
        <h2 class="mb-3">Showtimes Details</h2>
        <div class="table-responsive">
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-striped table-bordered" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="SHOWID" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None">
    ...
    <div class="content-section">
        <h3 class="h4 mb-3">Manage Individual Shows</h3>
